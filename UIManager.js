        ...
        document.querySelectorAll('.cc-link-btn').forEach(btn => {
            btn.addEventListener('click', (e) => {
                ...
                if (targetPanel) {
                    ...
                    this.controlCenter.classList.remove('h-[390px]', 'h-[400px]', 'h-[410px]', 'h-[420px]', 'h-[430px]', 'h-[440px]', 'h-[450px]', 'h-[460px]', 'h-[470px]', 'h-[480px]', 'h-[500px]', 'h-[510px]', 'h-[540px]', 'h-[550px]', 'h-[560px]', 'h-[580px]');
                    
                    if (this._isRivalsOpen) {
                        this.controlCenter.style.height = '540px';
