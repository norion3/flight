/**
 * AI可読性・先祖返り防止コメント:
 * 【フェーズ1: ダイナミック経済システムの定数定義（絶対安定・ネットワークボーナス版）】
 * 履歴331に基づき、超インフレを防ぎつつ長距離開拓のリターンを保証するため、
 * 平方根(Math.sqrt)カーブ計算用の係数 `DISTANCE_INCOME_RATE` を調整しました。
 */
